...
{
    /// <summary>Creates the self-contained Incantia Whisper recognition demonstration scene.</summary>
    public static class IncantationRecognitionExampleSceneBuilder
    {
        private const string ScenePath = "Assets/H1M4W4R1/Incantia/Examples/Scenes/IncantationRecognitionExample.unity";

        [MenuItem("Incantia/Create Recognition Example Scene")]
        public static void CreateScene()
        {
            Scene scene = EditorSceneManager.NewScene(NewSceneSetup.EmptyScene, NewSceneMode.Single);
            GameObject root = new GameObject("Incantia Recognition Example");
            ...
            GameObject controllerObject = new GameObject("Incantation Recognition UI");
            controllerObject.transform.SetParent(root.transform, false);
            IncantationRecognitionExampleController controller = controllerObject.AddComponent<IncantationRecognitionExampleController>();
